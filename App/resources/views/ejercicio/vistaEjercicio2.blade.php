...
<div class="col-md-3 p-0" id="bloqueSideBar" style="       background: #232323;webkit-box-shadow: 10px 0px 15px -9px rgba(0,0,0,0.75);-moz-box-shadow: 10px 0px 15px -9px rgba(0,0,0,0.75);box-shadow: 4px 0px 15px -9px rgba(0,0,0,0.75);z-index: 4;">
  ...
  margin-top: 1.6rem;
  overflow-y: scroll;">
  <div id="bloqueTablas" style="padding-top: 15px;">
    <h5 class="card-title" style="    border-bottom: 1px solid #4fe2ac !important;padding-left: 20px;padding-bottom: 7px;">Tablas disponibles</h5>
...
<ul class="nav nav-pills mt-4 mb-3" id="pills-tab" style="justify-content: center;"role="tablist">
  <li class="nav-item">
...
<div class="tab-pane fade cardBodyEnun cardEnunciado rounded" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab" style="width: 90%;
margin: auto;   background-color: #5a5a5a;
-webkit-box-shadow: 0px 0px 12px 3px rgba(0,0,0,0.75);
-moz-box-shadow: 0px 0px 12px 3px rgba(0,0,0,0.75);
box-shadow: 1px 1px 9px -1px rgba(0,0,0,0.75);
...
<div class="col-md-12 filaTabla">
  <div class="row">
    <div class="col-12">
      <span class="spanSugerencia" style="padding-left: 7px;">Ninguno de tus compañeros lo ha resuelto</span>
    </div>
  </div>
</div>
@endforelse
...
<div class="mt-4" style="height:45%;">
  <div class="mt-2 mb-2 cardBodyEnun cardEnunciado rounded temaAppTarjeta" style="width:90%;margin:auto;background-color: #5a5a5a;    -webkit-box-shadow: 0px 0px 12px 3px rgba(0,0,0,0.75);
  -moz-box-shadow: 0px 0px 12px 3px rgba(0,0,0,0.75);
  box-shadow: 1px 1px 9px -1px rgba(0,0,0,0.75);
  border-radius: 4px;">
  <div class="card-body text-left mb-2">
    <p class="card-text text-black" style="font-weight: bold;font-size: 14px;">
      <span style="color: darkmagenta;font-size: 15px;">Enunciado a resolver:</span> {{$enunciado}}
    </p>
  </div>
</div>
