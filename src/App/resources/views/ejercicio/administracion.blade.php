...
"><h1 class="mb-3" style="font-size: 2.5rem;">¡Bienvenido @if(auth()->user()->esProfesor ==  1) profesor @endif {{auth()->user()->name}}!</h1>
           ...
           <a href="https://github.com/rubenperezm/ChatbotSQL" target="_blank" class="enlaceIcon"data-toggle="tooltip" data-placement="top" title="Ir al repositorio del proyecto"><i class="fab fa-github"></i></a>
